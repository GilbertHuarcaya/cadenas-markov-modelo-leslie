  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-6 p-24">
      ...
      <p className="text-justify">
        ...
        transición entre una clase y otra. Además se tiene un vector que muestra
        la población actual de cada clase de edad. Finalmente se define la
        cantidad de periodos o años a simular.
      </p>
    </main>
  );
}
